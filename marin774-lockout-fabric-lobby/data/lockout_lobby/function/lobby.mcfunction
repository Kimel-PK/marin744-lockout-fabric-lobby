...
# - Global commands
setblock ~ 315 ~ minecraft:repeating_command_block{Command:"execute as @a at @s if block ~ ~-1 ~ minecraft:glass run team leave @s", auto:1b}
setblock ~ 314 ~ minecraft:repeating_command_block{Command:"execute as @a at @s if block ~ ~-1 ~ minecraft:glass run scoreboard players reset @a team_number", auto:1b}
setblock ~ 313 ~ minecraft:repeating_command_block{Command:"execute run function lockout_lobby:calm_players", auto:1b}
setblock ~ 312 ~ minecraft:repeating_command_block{Command:"execute as @a at @s if entity @s[x=-512,y=-64,z=-512,dx=512,dy=309,dz=512] run tp @s 0 318 0", auto:1b}


# - Team 1
fill ~4 316 ~-1 ~6 316 ~1 minecraft:red_concrete replace
setblock ~5 315 ~ minecraft:repeating_command_block{Command:"execute as @a[distance=..2] run team join 1", auto:1b}
setblock ~5 314 ~ minecraft:repeating_command_block{Command:"execute at @a[distance=..3] run scoreboard players set @a[distance=..3] team_number 1", auto:1b}
...
setblock ~ 315 ~5 minecraft:repeating_command_block{Command:"execute as @a[distance=..2] run team join 3", auto:1b}
setblock ~ 314 ~5 minecraft:repeating_command_block{Command:"execute at @a[distance=..3] run scoreboard players set @a[distance=..3] team_number 3", auto:1b}
...
setblock ~-5 315 ~ minecraft:repeating_command_block{Command:"execute as @a[distance=..2] run team join 5", auto:1b}
setblock ~-5 314 ~ minecraft:repeating_command_block{Command:"execute at @a[distance=..3] run scoreboard players set @a[distance=..3] team_number 5", auto:1b}
...
setblock ~ 315 ~-5 minecraft:repeating_command_block{Command:"execute as @a[distance=..2] run team join 7", auto:1b}
setblock ~ 314 ~-5 minecraft:repeating_command_block{Command:"execute at @a[distance=..3] run scoreboard players set @a[distance=..3] team_number 7", auto:1b}
